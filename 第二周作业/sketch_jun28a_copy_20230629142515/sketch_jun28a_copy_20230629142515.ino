...
void loop()
{
  ...
  case Active:
    ...
    err = theAudio->writeFrames(AudioClass::Player0, myFile);
    if(currentTrack.title=="music_1.mp3"){
      digitalWrite(LED3, bitRead(1, 0));
      digitalWrite(LED2, bitRead(1, 1));
      digitalWrite(LED1, bitRead(1, 2));
    }
    if(currentTrack.title=="music_2.mp3"){
      digitalWrite(LED3, bitRead(2, 0));
      digitalWrite(LED2, bitRead(2, 1));
      digitalWrite(LED1, bitRead(2, 2));
    }
    if(currentTrack.title=="music_3.mp3"){
      digitalWrite(LED3, bitRead(3, 0));
      digitalWrite(LED2, bitRead(3, 1));
      digitalWrite(LED1, bitRead(3, 2));
    }
    if(currentTrack.title=="music_4.mp3"){
      digitalWrite(LED3, bitRead(4, 0));
      digitalWrite(LED2, bitRead(4, 1));
      digitalWrite(LED1, bitRead(4, 2));
    }
    if(currentTrack.title=="Sound.mp3"){
      digitalWrite(LED3, bitRead(5, 0));
      digitalWrite(LED2, bitRead(5, 1));
      digitalWrite(LED1, bitRead(5, 2));
    }
    if(currentTrack.title=="Sound.wav"){
      digitalWrite(LED3, bitRead(6, 0));
      digitalWrite(LED2, bitRead(6, 1));
      digitalWrite(LED1, bitRead(6, 2));
    }
